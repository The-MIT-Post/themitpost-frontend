		...
		<nav className="dabba dabba-right">
			...
			<section className="social-media">
				<a
					...
					target="_blank"
					href="https://www.instagram.com/mit.post/?next=%2F&hl=en"></a>
				<a
					className="icon linkedin"
					target="_blank"
					href="https://www.linkedin.com/company/themitpost/"></a>
				<a
					className="icon spotify"
					target="_blank"
					href="https://open.spotify.com/user/lu00lx0xzwbjohh4ye9h4nfsz?si=1c6dc1763fa94dfa"></a>
				<a
					className="icon facebook"
					target="_blank"
					href="https://www.facebook.com/themitpost/"></a>
			</section>
