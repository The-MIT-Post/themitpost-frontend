...
const AdminDashboard = ({ articles }) => {
	...
	const handleGenerateFields = () => {
		setArticleData((prev) => ({
			...
			post_name: prev.title
				.toLowerCase()
				.replace(/[^a-z0-9]+/g, "-")
				.replace(/(^-|-$)/g, ""),
			link: `${window.location.origin}/articles/${prev.title
				.toLowerCase()
				.replace(/[^a-z0-9]+/g, "-")
				.replace(/(^-|-$)/g, "")}`,
		...
		<div className={styles.dashboard}>
			...
			<div className={styles.mainContent}>
				<div className={styles.header}>
					...
					<div className={styles.userAvatar}>{currentUser?.username?.charAt(0).toUpperCase()}</div>
				</div>
				...
				<div className={styles.formCard}>
					...
					<form onSubmit={handleSubmit}>
						...
						<div
							...
							<div className={styles.formGroup}>
								<label htmlFor="pubDate" className={styles.label}>
									Publication Date*
								</label>
								<input
									type="date"
						...
						<div
							...
							<div className={styles.formGroup}>
								<label htmlFor="guid" className={styles.label}>
									GUID*
								</label>
								<input
									type="text"
							...
							<div className={styles.formGroup}>
								<label htmlFor="post_id" className={styles.label}>
									Post ID*
								</label>
								<input
									type="text"
						...
						<div
							...
							<div className={styles.formGroup}>
								<label htmlFor="post_date" className={styles.label}>
									Post Date*
								</label>
								<input
									type="date"
							...
							<div className={styles.formGroup}>
								<label htmlFor="post_modified" className={styles.label}>
									Post Modified*
								</label>
								<input
									type="date"
						...
						<div
							...
							<div className={styles.formGroup}>
								<label htmlFor="post_name" className={styles.label}>
									Post Name
								</label>
								<input
									type="text"
